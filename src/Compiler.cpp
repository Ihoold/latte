...
void Compiler::visitWhile(While *while)
{
...
void Compiler::visitInt(Int *int)
{
...
void Compiler::visitBool(Bool *bool)
{
...
void Compiler::visitVoid(Void *void)
{
...
void Compiler::visitNot(Not *not)
{
