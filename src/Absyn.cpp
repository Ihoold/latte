...
/********************   StructDef    ********************/
StructDef::StructDef(Ident p1, ListAttribute *p2) {
    ident_ = p1;
    listattribute_ = p2;
...
/********************   LIdent    ********************/
LIdent::LIdent(Ident p1) {
    ident_ = p1;

}

LIdent::LIdent(const LIdent& other) {
    ident_ = other.ident_;

}

LIdent& LIdent::operator=(const LIdent& other) {
    LIdent tmp(other);
    swap(tmp);
    return *this;
}

void LIdent::swap(LIdent& other) {
    std::swap(ident_, other.ident_);
...
void LIdent::accept(Visitor *v) {
    v->visitLIdent(this);
}

LIdent *LIdent::clone() const {
    return new LIdent(*this);
}


/********************   LArray    ********************/
LArray::LArray(LVal *p1, Expr *p2) {
    lval_ = p1;
    expr_ = p2;

}

LArray::LArray(const LArray& other) {
...
void LArray::accept(Visitor *v) {
    v->visitLArray(this);
}

LArray *LArray::clone() const {
    return new LArray(*this);
}


/********************   LStruct    ********************/
LStruct::LStruct(LVal *p1, Ident p2) {
    lval_ = p1;
    ident_ = p2;
...
std::string Int::getTranslation() const {
    return "i32";
}
...
std::string Str::getTranslation() const {
    return "i8*";
}
...
std::string Bool::getTranslation() const {
    return "i1";
}
...
std::string Void::getTranslation() const {
    return "void";
}
...
const TypeSpecifier Array::getTypeSpecifier() const {
    return TypeSpecifier::Array;
}

Type *Array::getType_() const {
    return type_;
}

std::string Array::getTranslation() const {
    return type_->getTranslation() + "*";
}
...
const TypeSpecifier Struct::getTypeSpecifier() const {
    return TypeSpecifier::Struct;
}

const Ident& Struct::getIdent_() const {
    return ident_;
}

bool Struct::isEqual(const Type& t2) {
    auto t2_casted = dynamic_cast<const Struct&>(t2);
    return ident_ == t2_casted.getIdent_();
}

std::string Struct::getTranslation() const {
    return "%struct." + ident_ + "*";
}
...
/********************   EStruct    ********************/
EStruct::EStruct(Ident p1) {
    ident_ = p1;

}

EStruct::EStruct(const EStruct& other) {
    ident_ = other.ident_;

}

EStruct& EStruct::operator=(const EStruct& other) {
    EStruct tmp(other);
    swap(tmp);
    return *this;
}

void EStruct::swap(EStruct& other) {
    std::swap(ident_, other.ident_);
...
void EStruct::accept(Visitor *v) {
    v->visitEStruct(this);
}

EStruct *EStruct::clone() const {
    return new EStruct(*this);
}
...
bool typeIsDeclarable(TypePtr t) {
    return typeIn(t->getTypeSpecifier(), {TypeSpecifier::Int, TypeSpecifier::Bool,
                                         TypeSpecifier::String, TypeSpecifier::Struct,
                                         TypeSpecifier::Array, TypeSpecifier::SizedArray});
}

bool Type::isEqual(const Type& t2) {
    return true;
}

bool Type::operator==(const Type& t2) {
